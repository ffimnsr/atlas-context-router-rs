...
# Official Atlas installer.
# Runs on Unix-like shells and installs latest Atlas release from GitHub.

REPO_OWNER="ffimnsr"
REPO_NAME="atlas-context-router-rs"
PACKAGE_NAME="atlas"
...
main() {
    ...
    local _package
    _package="$(ensure download_atlas "${_arch}")"
