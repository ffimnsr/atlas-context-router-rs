...
use super::build::{
    enabled_registration_targets, graph_recovery_mode, persist_build_recovery_metadata,
    rebuild_result_label, rebuild_strategy_label,
};
            ...
            match &update_result {
                Ok(s) => {
                    let _ = store.finish_build_for_repo(
                        ...
                        BuildFinishStats {
                            state: update_state_for_summary(s),
