...
-- table: edges
CREATE TABLE edges ( id INTEGER PRIMARY KEY, kind TEXT NOT NULL, source_qualified TEXT NOT NULL, target_qualified TEXT NOT NULL, file_path TEXT, line INTEGER, confidence REAL DEFAULT 1.0, confidence_tier TEXT, extra_json TEXT , source_repo_id TEXT NOT NULL DEFAULT 'legacy');

-- table: files
CREATE TABLE files ( path TEXT NOT NULL, language TEXT, hash TEXT NOT NULL, size INTEGER, indexed_at TEXT NOT NULL, owner_id TEXT, owner_kind TEXT, owner_root TEXT, owner_manifest_path TEXT, owner_name TEXT, source_repo_id TEXT NOT NULL DEFAULT 'legacy', PRIMARY KEY (source_repo_id, path) );
...
-- table: nodes
CREATE TABLE nodes ( id INTEGER PRIMARY KEY, kind TEXT NOT NULL, name TEXT NOT NULL, qualified_name TEXT NOT NULL, file_path TEXT NOT NULL, line_start INTEGER, line_end INTEGER, language TEXT, parent_name TEXT, params TEXT, return_type TEXT, modifiers TEXT, is_test INTEGER NOT NULL DEFAULT 0, file_hash TEXT, extra_json TEXT, source_repo_id TEXT NOT NULL DEFAULT 'legacy', UNIQUE (source_repo_id, qualified_name) );
...
CREATE TABLE postprocess_state ( repo_root TEXT PRIMARY KEY, state TEXT NOT NULL, mode TEXT NOT NULL, stage_filter TEXT, changed_file_count INTEGER NOT NULL DEFAULT 0, stages_json TEXT, started_at_ms INTEGER, finished_at_ms INTEGER, last_error_code TEXT, last_error TEXT, updated_at_ms INTEGER NOT NULL , source_repo_id TEXT NOT NULL DEFAULT 'legacy');
...
-- index: idx_files_source_repo_path
...
-- index: idx_graph_build_state_source_repo
...
-- index: idx_nodes_source_repo_file_path
