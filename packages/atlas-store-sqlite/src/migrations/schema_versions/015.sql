...
-- table: files
CREATE TABLE files ( path TEXT PRIMARY KEY, language TEXT, hash TEXT NOT NULL, size INTEGER, indexed_at TEXT NOT NULL , owner_id TEXT, owner_kind TEXT, owner_root TEXT, owner_manifest_path TEXT, owner_name TEXT, source_repo_id TEXT NOT NULL DEFAULT 'legacy');
