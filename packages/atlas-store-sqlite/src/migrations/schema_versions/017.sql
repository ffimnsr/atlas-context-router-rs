...
-- table: nodes
CREATE TABLE nodes ( id INTEGER PRIMARY KEY, kind TEXT NOT NULL, name TEXT NOT NULL, qualified_name TEXT NOT NULL UNIQUE, file_path TEXT NOT NULL, line_start INTEGER, line_end INTEGER, language TEXT, parent_name TEXT, params TEXT, return_type TEXT, modifiers TEXT, is_test INTEGER NOT NULL DEFAULT 0, file_hash TEXT, extra_json TEXT , source_repo_id TEXT NOT NULL DEFAULT 'legacy');
...
-- index: idx_nodes_source_repo_qname
CREATE INDEX idx_nodes_source_repo_qname ON nodes (source_repo_id, qualified_name);
