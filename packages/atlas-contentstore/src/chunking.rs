...
//! - Each chunk preserves stable `chunk_index`
...
pub fn chunk_text(raw: &str, content_type: &str) -> Vec<Chunk> {
...
mod tests {
    ...
    fn markdown_split_by_headings() {
        let md = "# Intro\nhello\n## Details\nworld\n";
        let chunks = chunk_text(md, "text/markdown");
    ...
    fn plain_text_split_by_paragraph() {
        ...
        let chunks = chunk_text(txt, "text/plain");
        assert_eq!(chunks.len(), 2);
    }
    ...
    fn json_object_split_by_key() {
        ...
        let chunks = chunk_text(json, "application/json");
        assert_eq!(chunks.len(), 2);
    }
    ...
    fn chunk_indices_sequential() {
        let md = "# A\nfoo\n# B\nbar\n# C\nbaz\n";
        let chunks = chunk_text(md, "markdown");
    ...
    fn oversized_chunk_subdivided() {
        ...
        let chunks = chunk_text(&big, "text/plain");
