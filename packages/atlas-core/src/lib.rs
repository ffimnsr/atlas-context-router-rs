...
pub use model::{
    ...
    ConfidenceTier, ContentAsset, ContentAssetReason, ContextIntent, ContextRankingEvidence,
    ContextRequest, ContextResult, ContextScoreEvidence, ContextTarget, CoverageStrength,
    DeadCodeCandidate, DependencyRemovalResult, Edge, ExtractFunctionCandidate, FileRecord, Flow,
    FlowMembership, FuzzyCorrectionEvidence, GraphExpansionEvidence, GraphStats,
    HybridRankContribution, HybridRankingSource, HybridRrfEvidence, ImpactClass, ImpactResult,
    ImpactedNode, MixedResultKind, Node, NodeId, NoiseReductionSummary, PackageOwner,
    PackageOwnerKind, ParsedFile, PayloadTruncationMeta, PostprocessExecutionMode,
