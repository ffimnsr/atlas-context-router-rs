...
pub use model::{
    AdvancedImpactResult, AmbiguityMeta, ArchitectureReport, BoundaryKind, BoundaryViolation,
    ChangeKind, ChangeRiskResult, ChangeType, ChangedFile, ChangedSymbolSummary, Community,
    CommunityNode, ConfidenceTier, ContentAsset, ContentAssetReason, ContextIntent,
    ContextRankingEvidence, ContextRequest, ContextResult, ContextScoreEvidence, ContextTarget,
    CoverageStrength, DeadCodeCandidate, DependencyRemovalResult, Edge, ExtractFunctionCandidate,
    FileRecord, Flow, FlowMembership, FreshnessWarning, FuzzyCorrectionEvidence,
    GraphExpansionEvidence, GraphStats, HybridRankContribution, HybridRankingSource,
    HybridRrfEvidence, ImpactClass, ImpactResult, ImpactedNode, InsightEvidence, InsightFinding,
    InsightLineRange, InsightSeverity, InsightSummary, LargeFunctionReport, MetricsReport,
    MixedResultKind, Node, NodeId, NoiseReductionSummary, PackageOwner, PackageOwnerKind,
    ParsedFile, PatternReport, PayloadTruncationMeta, PostprocessExecutionMode,
    PostprocessRunState, PostprocessRunSummary, PostprocessStageStatus, PostprocessStageSummary,
    PostprocessStatus, ProvenanceMeta, RankingEvidence, ReasoningEvidence, ReasoningWarning,
    ...
    ReviewImpactOverview, RiskLevel, RiskReport, RiskSummary, SafetyBand, SafetyScore,
    SavedContextSource, ScoreEvidence, ScoredImpactNode, ScoredNode, SearchMatchedField,
    SearchQuery, SelectedEdge, SelectedFile, SelectedNode, SelectionReason,
